...
> Archived Python/Qt implementation. Version 0.6.8 is the final Python
> release; active desktop development continues in the repository's `app/`
> Tauri application. This directory is retained for release reproducibility
