...
- Final Python/Qt release.
- Preserved as the compatibility baseline for the first Tauri release.
- Desktop development and packaging move to the Rust/Tauri application in
  version 0.7.0.
