# Native platform acceptance ledger

Python 0.6.8 is the archived historical baseline. A checked item has a real
Rust/Tauri implementation, not a static mock. The remaining unchecked items
are ongoing platform acceptance work, not blockers to repository migration.
