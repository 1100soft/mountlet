...
def _merge_app_config_from_archive(archive: zipfile.ZipFile, destination: Path) -> None:
    ...
    merged = AppSettings(
        ...
        window_mode=incoming.window_mode,
        theme=incoming.theme,
        ui_zoom_steps=incoming.ui_zoom_steps,
        integrated_file_edits=incoming.integrated_file_edits,
        file_list_max_items=incoming.file_list_max_items,
        remote_sync_interval_seconds=incoming.remote_sync_interval_seconds,
        notice_info_display=incoming.notice_info_display,
        notice_important_display=incoming.notice_important_display,
        notice_check_interval_seconds=incoming.notice_check_interval_seconds,
...
def _shared_app_settings_payload(settings: AppSettings) -> dict[str, object]:
    return {
        ...
        "ui_zoom_steps": settings.ui_zoom_steps,
        "remote_sync_interval_seconds": settings.remote_sync_interval_seconds,
        "notice_info_display": settings.notice_info_display,
        "notice_important_display": settings.notice_important_display,
        "notice_check_interval_seconds": settings.notice_check_interval_seconds,
